...
function getVersionLabel() {
    ...
    var headUrl = "$HeadURL: svn+ssh://ebariaux@svn.code.sf.net/p/openremote/code/workspace/ebariaux/Controller_Pro_1_5_0_ORCJAVA-511/src/main/webapp/js/index.js $";
